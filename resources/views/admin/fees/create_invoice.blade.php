...
@section('pageTitle', 'Create Invoice - Student Profile Management')
    ...
    <div class="col-md-12">
      <div class="card card-primary">
        ...
        <div class="card-body" id="app">
          <form action="{{ route('fees.invoices.store') }}" method="POST">
            @csrf
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="text" name="invoice_date" class="form-control flatpickr" value="{{ old('invoice_date', now()->format('Y-m-d')) }}" required>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-group">
                  <label>Due Date</label>
                  <input type="text" name="due_date" class="form-control flatpickr" value="{{ old('due_date') }}">
                </div>
              </div>
            </div>
            ...
            <table class="table table-bordered" id="invoiceItemsTable">
              <thead>
                <tr><th>Fee Type</th><th>Description</th><th>Qty</th><th>Unit Price</th><th>Total</th><th></th></tr>
              </thead>
              <tbody>
                <tr class="item-row">
                  <td>
                  ...
                  <td><input type="number" name="items[0][unit_price]" class="form-control unit-price" step="0.01" value="0"></td>
              ...
              <tfoot>
                <tr>
                  <td colspan="6">
                    <button type="button" class="btn btn-success btn-sm" id="addItemRow"><i class="fas fa-plus"></i> Add Item</button>
                  </td>
                </tr>
              </tfoot>
            </table>
            ...
            <div class="row">
              <div class="col-md-6 offset-md-6">
                <table class="table table-bordered">
                  <tr><th>Grand Total</th><td id="grandTotal">0.00</td></tr>
                </table>
              </div>
            </div>
