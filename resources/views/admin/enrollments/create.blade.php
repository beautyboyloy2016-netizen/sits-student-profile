...
@section('pageTitle', 'Add Enrollment - Student Profile Management')
      ...
      <div class="card card-primary">
        ...
        <div class="card-body" id="app">
          <form action="{{ route('enrollments.store') }}" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select name="class_id" class="form-control tom-select" required>
                    ...
                    @foreach($classes as $class)
                      <option value="{{ $class->id }}" {{ old('class_id') == $class->id ? 'selected' : '' }}>{{ $class->class_code }} - {{ $class->course->name ?? '' }} ({{ $class->level->name ?? '' }})</option>
                    @endforeach
                  </select>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="enroll_date" class="form-control flatpickr" value="{{ old('enroll_date', now()->format('Y-m-d')) }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="study_time_label" class="form-control" value="{{ old('study_time_label') }}" placeholder="e.g. Morning, Afternoon">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Save Enrollment</button>
